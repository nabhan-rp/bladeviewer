                 ...
                 <div>
                    ...
                    {settings.hideTableBorders && (
                        <div className="pl-6 animate-fadeIn">
                            <label className="text-[10px] text-gray-400 block mb-1 font-bold">Affected Pages</label>
                            <input 
                                type="text"
                                placeholder="e.g. 1, 3-5 (Empty = All Pages)"
                                value={settings.hideTableBordersPages || ""}
                                onChange={(e) => updateSetting('hideTableBordersPages', e.target.value)}
                                className="w-full bg-gray-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white rounded-xl px-3 py-2 text-sm text-gray-800 transition-all outline-none"
                            />
                            <p className="text-[9px] text-gray-400 mt-1">
                                Enter page numbers (1) or ranges (1-3). Leave empty to hide borders on all pages.
                            </p>
                        </div>
                    )}
                 </div>
